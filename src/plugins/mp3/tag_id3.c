...
typedef enum EXTRACTOR_KeywordType tag_type;
...
//			    TAG_ALBUM_ARTIST_SORT);
	tag_id3_import_text(ret, tag, ID3_FRAME_TITLE, EXTRACTOR_TITLE);
	tag_id3_import_text(ret, tag, ID3_FRAME_ALBUM, EXTRACTOR_ALBUM);
	tag_id3_import_text(ret, tag, ID3_FRAME_TRACK, EXTRACTOR_TRACK_NUMBER);
	tag_id3_import_text(ret, tag, ID3_FRAME_YEAR, EXTRACTOR_DATE);
	tag_id3_import_text(ret, tag, ID3_FRAME_GENRE, EXTRACTOR_GENRE);
	tag_id3_import_text(ret, tag, ID3_FRAME_COMPOSER, EXTRACTOR_AUTHOR);
//	tag_id3_import_text(ret, tag, "TPE3", TAG_ITEM_PERFORMER);
//	tag_id3_import_text(ret, tag, "TPE4", TAG_ITEM_PERFORMER);
	tag_id3_import_comment(ret, tag, ID3_FRAME_COMMENT, EXTRACTOR_COMMENT);
